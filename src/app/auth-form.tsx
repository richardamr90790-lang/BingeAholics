...
function EnterWorldOverlay() {
  return (
    <div className="fixed inset-0 z-[100] overflow-hidden bg-[#0a0a10]">
      <div
...
export function AuthForm() {
  ...
  return (
    <>
      <div
        className={`w-full max-w-md rounded-2xl border border-white/20 bg-zinc-950/30 p-6 shadow-2xl backdrop-blur-3xl transition-all duration-500 ${
          entering ? "scale-95 opacity-0" : ""
        }`}
      >
        <Fields key={mode} mode={mode} onEnter={enter} />
